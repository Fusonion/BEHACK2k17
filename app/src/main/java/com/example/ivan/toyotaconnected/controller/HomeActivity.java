package com.example.ivan.toyotaconnected.controller;
...
import com.example.ivan.toyotaconnected.controller.report.ViewMapFragment;
import com.example.ivan.toyotaconnected.controller.user.ViewUserProfileFragment;
...
public class HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    @Override
    public void onBackPressed() {   // EDIT THIS TO CHANGE FROM MAP TO REGULAR SHIT
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout);
        Fragment fragById = fragmentManager.findFragmentById(R.id.fragment_home_container);
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            // Close drawer if it is open
            drawer.closeDrawer(GravityCompat.START);
        } else if (fragById.getClass() != ViewMapFragment.class) {
     ...
     */
    public void switchToWaterReportCreate(Bundle bundle) { //Function to switch to first menu Item
     ...
     */
    public void switchToHistogram(Bundle bundle, WaterReport waterReport) { //Function to switch to second menu item
